			...
			<div class="banner-caption">
				...
				<div class="col-md-8 col-md-offset-4">
					<ul class="nav nav-pills">
						<li class="active"><a href=goToLogin>Create an account</a></li>
						<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
						<li class="active"><a href=goToSignup>please let me log in</a></li>
					</ul>
				</div>
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									...
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-1">哇哇哇哇 Title</a>
								</div>
								<!-- Modal -->
