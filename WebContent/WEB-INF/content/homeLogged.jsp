...
<body class="no-trans">
	...
	<div class="default-bg space blue">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h1 class="text-center">Hello, <a target="_blank" href="goProfile?name=${user.nickname}"><s:property value="user.nickname"/></a></h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-sm-6">
					...
					<div class="media">
						...
						<div class="media-body">
							...
							<p>我们还提供普适表格抽取功能，如果我们提供的模式都不满足您的要求，您可以尝试用自定义模式抽取您需要的表格信息，但是可能存在由于格式不兼容导致抽取失败的情况。</p><br />
						</div>
					</div>
					<div class="media">
						<div class="media-left">
