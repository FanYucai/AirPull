...
var content= '<s:property value="fileUploadToolsOw.feifeiContent"/>';
var output= '<s:property value="fileUploadToolsOw.feifeiContent"/>';
</script>
<html lang="en">    
<head>    
...
<form action="exportExcel" method="post">
	<%-- <input type="hidden" name="fileContent" value='<s:property value="fileUploadToolsOw.fileContent"/>' > --%>
